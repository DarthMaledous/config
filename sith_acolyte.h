...
{"KSith_Ascension", "tracks/swtor_epic3.wav",
...
StylePtr<InOutHelper<OnSpark<SimpleClash<Lockup<Blast<AudioFlicker<Red,Rgb<155,0,0>>,ColorSequence<500,Cyan,Green,Yellow>,400>,Gradient<StyleFire<HumpFlicker<Green,Magenta,50>,RandomPerLEDFlicker<Black,Magenta>,0,2,FireConfig<0,2000,1>,FireConfig<3000,0,0>,FireConfig<0,5000,10>,FireConfig<0,0,5>>,BrownNoiseFlicker<Pulsing<GhostWhite,Red,2800>,Pulsing<GhostWhite,Yellow,2800>,50>,BrownNoiseFlicker<Black,RandomPerLEDFlicker<Tomato,Magenta>,50>,StyleFire<HumpFlicker<Green,Magenta,50>,BrownNoiseFlicker<Black,Magenta,50>,0,2,FireConfig<0,2000,2>,FireConfig<3000,0,0>,FireConfig<0,5000,10>,FireConfig<0,0,1>>>,AudioFlicker<Blue,White>>,Gradient<StyleFire<DarkOrange,Black>,BrownNoiseFlicker<White,Magenta,50>,StyleFire<Red,Red,0,2,FireConfig<0,2000,5>,FireConfig<3000,0,0>,FireConfig<0,5000,10>,FireConfig<0,0,2>>>,240>,White,800>,190,500>>(), "red"},
	
   
{"Pitch-Black", "tracks/swtor_darksidetheme4.wav",
StylePtr<InOutHelper<OnSpark<Blast<LocalizedClash<Lockup<RandomFlicker<Red,Rgb<180,0,0>>,Pulsing<Gradient<RandomFlicker<Red,Rgb<180,0,0>>,RandomFlicker<Red,Rgb<180,0,0>>,Strobe<White,BrownNoiseFlicker<Red,White,100>,50,1>,RandomFlicker<Red,Rgb<180,0,0>>,RandomFlicker<Red,Rgb<180,0,0>>>,Gradient<RandomFlicker<Red,Rgb<180,0,0>>,RandomFlicker<Red,Rgb<180,0,0>>,Strobe<White,BrownNoiseFlicker<Red,White,100>,50,1>,RandomFlicker<Red,Rgb<180,0,0>>,RandomFlicker<Red,Rgb<180,0,0>>,RandomFlicker<Red,Rgb<180,0,0>>>,3500>,RandomPerLEDFlicker<Red,White>>,ColorSequence<500,GhostWhite,Yellow>,90,70>,ColorSequence<650,Green,Rgb<155,0,255>,GhostWhite,Yellow>,400>,GhostWhite,575>,200,500>>(), "red"},
