...
StylePtr<Layers<
  ...
  LockupTrL<AlphaL<BrownNoiseFlicker<DodgerBlue,Magenta,175>,Int<32000>>,TrWipeInSparkTipX<Snow,Int<425>,Int<175>>,TrWaveX<White>,SaberBase::LOCKUP_LIGHTNING_BLOCK>,
  ...
  TransitionEffectL<TrConcat<TrSmoothFade<800>,Gradient<Black,HumpFlicker<Snow,LightYellow,50>,AudioFlicker<DeepSkyBlue,SteelBlue>>,TrSmoothFade<1800>>,EFFECT_IGNITION>,
  TransitionEffectL<TrConcat<TrInstant,Stripes<2500,3000,SteelBlue,Snow,DeepSkyBlue,Ivory>,TrWipeIn<500>>,EFFECT_RETRACTION>,
  InOutTrL<TrWipe<200>,TrWipeIn<500>>>>(), "Preset 3"},
